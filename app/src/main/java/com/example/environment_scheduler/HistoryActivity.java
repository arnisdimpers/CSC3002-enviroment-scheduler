...
public class HistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> dropAdapter = new ArrayAdapter<String>(HistoryActivity.this, android.R.layout.simple_spinner_item, dropList);
        ...
        myAdapter = new MyAdapter(this, list, "chooseroom"); // Populate the array
...
//                    String key = dataSnapshot.getKey();
                    ...
                    String room = meeting.getRoomnum();

                    dropList.add(room);
                    dropAdapter.notifyDataSetChanged();
                    Log.d("ROOMS ADDED: ", ""+room);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                try {
                    ...
                    Toast.makeText(HistoryActivity.this, "Selected Room: #" + value, Toast.LENGTH_SHORT).show();

                } catch (NullPointerException e) {
                    Toast.makeText(HistoryActivity.this, "No available rooms selected.", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        gobackButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                Toast.makeText(HistoryActivity.this, "Going back to main page", Toast.LENGTH_SHORT).show();
                Intent gobackActivity = new Intent(HistoryActivity.this, AdminMainActivity.class);
        ...
        confirmButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                try {
                    Toast.makeText(HistoryActivity.this, "Confirming selected meeting", Toast.LENGTH_SHORT).show();
                    Intent confirmActivity = new Intent(HistoryActivity.this, HistoryNameActivity.class);
                    ...
                    Toast.makeText(HistoryActivity.this, "Please select an available room.", Toast.LENGTH_SHORT).show();
                }
